...
def calculate_correlations(user_centric_array, film_correlations_number):
	...
	# Start calculations
#	calculation_thread[blockspergrid, threadsperblock](user_centric_array_global_mem, correlation_matrix_global_mem, number_users)
	calculation_thread[1, 1](user_centric_array_global_mem, correlation_matrix_global_mem, number_users, film_correlations_number)
...
if __name__ == "__main__":
	execute_tests.launcher("cuda_1simple")
